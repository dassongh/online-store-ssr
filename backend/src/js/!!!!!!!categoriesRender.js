const refs = {
  links: document.querySelectorAll('[data-category]'),
  container: document.querySelector('.collection__choice-main'),
};
...
function renderProducts(products) {
  ...
  products.forEach(product => {
    ...
    const markup = `<div class="owl-card">
                  <div class="thumb">
                    ...
                    ${
                      old_price && isNew
                       ...
                       <div class="thumb__discount thumb__discount--both-new" > <span class="thumb__discount-number">new</span></ > `
                        : isNew
